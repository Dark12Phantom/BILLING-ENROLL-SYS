    ...
    <div class="col-md-4 mb-4">
        <div class="card text-white bg-primary h-100">
            <div class="card-body">
                ...
                <a href="students/index.php" class="text-white">View Students</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
        <div class="card text-white bg-success h-100">
            <div class="card-body">
                ...
                <a href="students/billing/index.php" class="text-white">View Payments</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
        <div class="card text-white bg-warning h-100">
            <div class="card-body">
                ...
                ?>
                <h2 class="card-text"><?php echo $count; ?></h2>
                <a href="students/billing/fees.php" class="text-white">View Pending Fees</a>
            </div>
        </div>
    </div>
</div>
