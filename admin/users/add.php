...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $requiredFields = [
        ...
        'gender', 'address', 'username', 'email', 'password'
    ];
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="mobile_number" name="mobile_number" value="<?php echo isset($_POST['mobile_number']) ? htmlspecialchars($_POST['mobile_number']) : ''; ?>">
                                </div>
                            </div>
                        </div>
